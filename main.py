...
path_data = "./data"
path_persist = os.path.join(path_data, "persist")

Settings.llm = OpenAI(temperature=1.0, model="gpt-4o-mini")
...
template = (
    ...
    "Given only this information and without using ur general knowledge, always answer in german: {query_str}\n"
